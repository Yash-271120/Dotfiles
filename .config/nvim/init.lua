...
vim.keymap.set("n", "<C-h>", ":TmuxNavigateLeft<CR>", { desc = "Go to Left Window", silent = true })
vim.keymap.set("n", "<C-j>", ":TmuxNavigateDown<CR>", { desc = "Go to Lower Window", silent = true })
vim.keymap.set("n", "<C-k>", ":TmuxNavigateUp<CR>", { desc = "Go to Upper Window", silent = true })
vim.keymap.set("n", "<C-l>", ":TmuxNavigateRight<CR>", { desc = "Go to Right Window", silent = true })
vim.keymap.set("n", "<C-d>", "<C-d>zz", { desc = "Scroll down with centering" })
vim.keymap.set("n", "<C-u>", "<C-u>zz", { desc = "Scroll up with centering" })
vim.keymap.set("n", "n", "nzzzv", { desc = "Search next term with centering" })
vim.keymap.set("n", "N", "Nzzzv", { desc = "Search prev term with centering" })
...
-- paste and keep it in clipboard
vim.keymap.set("x", "<leader>p", '"_dP', { desc = "Paste without losing in clipboard" })
